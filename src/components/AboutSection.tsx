          ...
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-8 rounded-3xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 transform hover:shadow-2xl transition-all duration-500">
            <div className="space-y-8">
              <div className="text-center">
                <div className="relative group mb-6">
                  <img 
                    ...
                    alt="Who We Are"
                    className="w-full max-w-2xl mx-auto h-auto rounded-2xl shadow-lg transform group-hover:scale-105 transition-transform duration-500"
                  />
              ...
              <div className="space-y-6">
                <h3 className="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-4 text-center">WHO WE ARE</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-center max-w-5xl mx-auto">
        ...
        <div>
          ...
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-8 rounded-3xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 transform hover:shadow-2xl transition-all duration-500">
            <div className="space-y-8">
              <div className="text-center">
                <div className="relative group mb-6">
                  <img 
                    ...
                    alt="Our Credentials"
                    className="w-full max-w-2xl mx-auto h-auto rounded-2xl shadow-2xl transform group-hover:scale-105 transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <h3 className="text-2xl font-bold text-orange-600 dark:text-orange-400 mb-4 text-center">CREDENTIALS:</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-center max-w-5xl mx-auto">
